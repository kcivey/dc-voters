...
module.exports = function (db) {
    ...
    db.getLineCountsForCirculatorByWard =
        function ({project, circulatorId, startDate = null, endDate = null, unpaid = false}) {
            let sql =
                `SELECT p.date_checked, l.page, l.ward, COUNT(*) AS valid, MAX(p.date_signed) AS date_signed
            ...
            sql += ' GROUP BY p.date_checked, l.page, l.ward ORDER BY p.date_checked, l.page, l.ward';
            return queryPromise(sql, values);
        };
